...
/*	const sleep = (ms) => {new Promise(resolve => setTimeout(resolve, ms))}
	...
	// theme control
	var whoIs = window.location.href.replace('index.html', '');
	const medievalTheme = whoIs + 'assets/medieval.css';
	const lightTheme = whoIs + 'assets/light.css';
	const darkTheme = whoIs + 'assets/dark.css';
	var cssState = '';

	$('#theme').on('click touch', function() {
		cssState = document.getElementById('theme_css').href;
		console.log('theme change');
		console.log('Dark theme location: ' + darkTheme);
